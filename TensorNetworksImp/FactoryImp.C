...
Make1D_NN_HeisenbergHamiltonian(int L, double S, double Jxy, double Jz, double hz,TriType ul)
{
...
Hamiltonian*   FactoryImp::
Make1D_NN_TransverseIsingHamiltonian(int L, double S, double J, double hx,TriType ul)
{
