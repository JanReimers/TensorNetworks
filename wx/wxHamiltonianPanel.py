...
class wxHamiltonianPanel(wx.Panel):
    def __init__(self,parent):
        ...
        fgsizer.Add(spint,border=5,flag=wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT)
        ...
        sizer.Add(fgsizer,border=5,flag=wx.ALL)
        self.SetSizer(sizer)
    ...
    def JxAddrow(self,text,initialValue,sizer):
        ...
        html = wx.html.HtmlWindow(self,size=wx.Size(-1,H) ,style=wx.html.HW_SCROLLBAR_NEVER | wx.html.HW_NO_SELECTION)
        html.SetPage("<html><body><p align=\"right\"><i>"+text+":&nbsp;</i></p></body></html>")
        sizer.Add(html,flag=wx.EXPAND|wx.ALIGN_TOP|wx.ALIGN_RIGHT )
        sizer.Add(Jexchange)
        return Jexchange
