...
/*! \class rc_ptr rc_ptr.h Containers/rc_ptr.h
...
{
public:
  //! Construct. If pointer is supplied then rc_ptr now \b owns that pointer.
  rc_ptr(X* p = 0);
  //! Copy construct. Object does not get copied.
